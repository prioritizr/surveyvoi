...
Rcpp::NumericVector approx_expected_value_of_decision_given_survey_scheme(
  ...
  //   n_f_survey * n_approx_replicates * n_approx_outcomes_per_replicate);
  ...
  //     seed + static_cast<double>(r), outcomes);
  //   set_seed(seed);
  //
  ...
  //       expected_value_of_action(curr_solution, curr_pij, obj_fun_target);
  //
