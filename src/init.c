...
extern SEXP _surveyvoi_rcpp_approximate_expected_value_of_management_decision_given_current_information_fixed_states(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _surveyvoi_rcpp_approximate_expected_value_of_management_decision_given_current_information_n_states(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_surveyvoi_rcpp_approximate_expected_value_of_management_decision_given_current_information_fixed_states", (DL_FUNC) &_surveyvoi_rcpp_approximate_expected_value_of_management_decision_given_current_information_fixed_states, 9},
    {"_surveyvoi_rcpp_approximate_expected_value_of_management_decision_given_current_information_n_states",     (DL_FUNC) &_surveyvoi_rcpp_approximate_expected_value_of_management_decision_given_current_information_n_states,     9},
