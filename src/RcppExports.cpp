...
double rcpp_approx_expected_value_of_action(std::vector<bool> solution, Eigen::MatrixXd pij, Eigen::VectorXd preweight, Eigen::VectorXd postweight, Eigen::VectorXd target, std::size_t n_approx_states);
RcppExport SEXP _surveyvoi_rcpp_approx_expected_value_of_action(SEXP solutionSEXP, SEXP pijSEXP, SEXP preweightSEXP, SEXP postweightSEXP, SEXP targetSEXP, SEXP n_approx_statesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_approx_expected_value_of_action(solution, pij, preweight, postweight, target, n_approx_states));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_approx_expected_value_of_decision_given_current_info
double rcpp_approx_expected_value_of_decision_given_current_info(Eigen::MatrixXd& pij, Eigen::VectorXd& pu_costs, Eigen::VectorXd& pu_locked_in, Eigen::VectorXd& pu_locked_out, Eigen::VectorXd& preweight, Eigen::VectorXd& postweight, Eigen::VectorXd& target, double budget, double gap, std::size_t n_approx_states);
RcppExport SEXP _surveyvoi_rcpp_approx_expected_value_of_decision_given_current_info(SEXP pijSEXP, SEXP pu_costsSEXP, SEXP pu_locked_inSEXP, SEXP pu_locked_outSEXP, SEXP preweightSEXP, SEXP postweightSEXP, SEXP targetSEXP, SEXP budgetSEXP, SEXP gapSEXP, SEXP n_approx_statesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd& >::type pij(pijSEXP);
