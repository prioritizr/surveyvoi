...
xgb_parameters <- list(eta = c(0.1, 0.3, 1), lambda = c(0.01, 0.1, 0.5),
...
xgb_results <- fit_occupancy_models(
  site_data, "f1", c("e1", "e2"), xgb_n_folds = 2,
